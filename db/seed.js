...
const seedProducts = () => db.Promise.map([
	...
	{title: 'monument for V. Tatlin', artist: {name: 'Dan Flavin' }, year: 1968 , image:  , price: 2500 , tags: ['Dan Flavin', 'White', 'Sculpture', 'Light Sculpture'] , description: , medium: 'Sculpture', dimensions: [60.96, 10, 177.8] , quantity: 1}
